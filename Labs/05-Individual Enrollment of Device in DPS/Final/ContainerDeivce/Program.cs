...
namespace ContainerDevice
{
    class Program
    {
        ...
        private static string dpsIdScope = "0ne0062BFE1";
        // Registration ID
        private static string registrationId = "sensor-thl-1000";
        // Individual Enrollment Primary Key
        private const string individualEnrollmentPrimaryKey = "EfNS78wxJ4t/8gvjUgi3SbRrj2d+iVKX9G3hNiC+JeHpVNWd5jcpRjdNB174H+dfbgjAIk+wRvTXwoPLziUKsg==";
        // Individual Enrollment Secondary Key
        private const string individualEnrollmentSecondaryKey = "IFrvRqxrL+5UESOGkZj80CZycfv8xpjRhl9Xr5SeZ4QMUJZM2Y6ZOu75e7VRfO8Bw0tdBDJSeZQgxJiVLGbziQ==";
